  ...
  >
    <defs>
      <path
        id="circularTextPath"
        fill="none"
        d="M248,248 m-215,0 a215,215 0 1,1 430,0 a215,215 0 1,1 -430,0"
      />
    </defs>
    <text fontSize="27" fontWeight="600" letterSpacing="2">
      <textPath href="#circularTextPath" startOffset="0%">
        TECH LEAD-TRACK • ENGENHEIRO DE SOFTWARE SÊNIOR • ESPECIALISTA EM SDD •{" "}
        TECH LEAD-TRACK • ENGENHEIRO DE SOFTWARE SÊNIOR • ESPECIALISTA EM SDD •
      </textPath>
    </text>
  </svg>
