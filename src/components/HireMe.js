...
const HireMe = () => {
  return (
    <div className="lg:z-10 fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0">
      <div className="w-48 h-auto items-center justify-center relative md:w-24">
        ...
        <Link
          ...
          dark:hover:bg-dark dark:hover:text-light dark:bg-light dark:text-dark dark:border-light md:w-12 md:h-12 md:text-[10px]
          "
        >
          Contrate
        </Link>
